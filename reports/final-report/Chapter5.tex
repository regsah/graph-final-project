...
coexistent avec de nombreux noeuds de faible degre, comme on l'observe sur la
Figure~\ref{fig:final-degree-loglog}.
...
l'espace des embeddings, comme le montre la Figure~\ref{fig:final-cosine-assort}.
...
influencent tous les articles qu'un modele a tendance a faire remonter. La
Figure~\ref{fig:final-centrality} resume la dispersion des mesures de
centralite, tandis que la Figure~\ref{fig:final-louvain} montre la
distribution des tailles de communautes obtenues par Louvain.
...
L'etape majeure suivante a consiste en la comparaison de huit modeles,
resumee dans les comparaisons initiales. Dans ce premier dispositif
d'evaluation, Node2Vec non corrige semblait dominer la famille de modeles. Le
Tableau~\ref{tab:final-report6-topline} reproduit les resultats les plus
importants de ces comparaisons initiales, car ils fournissent le recit de
reference qui a du etre reexamine par la suite.
