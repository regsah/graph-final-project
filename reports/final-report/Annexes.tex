...
\section{Gains relatifs}

Le Tableau~\ref{tab:annex-relative-gains} resume l'analyse des gains relatifs en
pourcentage. Les valeurs positives indiquent une amelioration dans le sens approprie de la metrique.

\begin{table}[H]
\centering
\caption{Ameliorations relatives (\%)}
