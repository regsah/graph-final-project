...
Le système de recommandation proposé suit une architecture en pipeline à trois couches qui transforme séquentiellement les données brutes de Wikipédia en parcours d'apprentissage exploitables. Chaque couche est conçue pour être modulaire, permettant une expérimentation indépendante et une extension future.
...
\textbf{Couche 1 -- Préparation des Données:} La topologie du graphe WikiCS est chargée et enrichie avec le contenu textuel des articles fetched via l'API Wikipédia. Le Wiki Stem Corpus fournit des données textuelles supplémentaires pour les articles. Le graphe résultant contient 11\,367 nœuds (articles CS) et 291\,039 arêtes dirigées (hyperliens).
