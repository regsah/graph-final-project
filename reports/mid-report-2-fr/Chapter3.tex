...
\begin{itemize}
    ...
    \item \textbf{Biais de représentation des connaissances:} La structure d'hyperliens de Wikipédia reflète les décisions éditoriales de millions de contributeurs, embed potentially embedding des biais systémiques (ex. sur-représentation de certains sujets, biais de genre dans la couverture des articles).
