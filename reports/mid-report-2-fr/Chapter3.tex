...
\begin{itemize}
    \item \textbf{Efficacité d'entraînement:} Tous les modèles GNN sont conçus pour converger en 100 époques, avec arrêt précoce pour éviter le calcul inutile. Une session d'entraînement typique consomme environ 0.06--0.10 kWh.
