...
\begin{equation}
Hit@K = \frac{1}{|Q|}\sum_{q \in Q} \mathbf{1}[r_q \le K]
\end{equation}
...
This work is supported by the Galatasaray University Research Fund (BAP) within the scope of project number FBA-2026-1345, titled \textit{Çok Modlu Öneri Sistemlerinde Doğruluk, Çeşitlilik, Adalet ve}.
