...
\section{Custom-WikiCS Reconstruction}

\subsection{Motivation and Reconstruction Pipeline}
...
\centering
\includegraphics[width=\textwidth]{../../final-report/figures/degree-log-log.png}
\par\small (a) Log-log degree distribution
\end{minipage}\hfill
\begin{minipage}[t]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{../../final-report/figures/cosine-similarity-assortativity.png}
...
\centering
\includegraphics[width=\textwidth]{../../final-report/figures/community-size-distribution-louvain.png}
\par\small (a) Louvain community size distribution
\end{minipage}\hfill
\begin{minipage}[t]{0.55\textwidth}
\centering
\includegraphics[width=\textwidth]{../../mid-report-2-en/figures/similarity-distributions.png}
...
\subsection{Structural Retrieval}
...
\subsection{Hybrid and GNN-Based Models}
...
\subsection{Combined Metrics on the Revised Protocol}
...
\subsection{Cutoff-10 and Link-Discrimination Metrics}
