...
\begin{table}[H]
\centering
\caption{Ranking results on the revised undirected structural branch (86,446 expanded evaluation pairs).}
\begin{tabular}{>{\raggedright\arraybackslash}p{0.33\textwidth}
                ...
                >{\raggedleft\arraybackslash}p{0.07\textwidth}}
\toprule
\textbf{Model} & \textbf{H@1} & \textbf{H@10} & \textbf{H@50} & \textbf{H@100} & \textbf{MRR} & \textbf{NDCG} & \textbf{Recall} & \textbf{MAP} \\
\midrule
BGE pooled + Node2Vec (corrected) & 1.03\% & 8.67\% & 31.46\% & 47.81\% & 0.0410 & 0.1160 & 0.4781 & 0.0392 \\
BGE-M3 + Node2Vec (corrected) & 1.07\% & 8.67\% & 32.41\% & 49.81\% & 0.0421 & 0.1202 & 0.4981 & 0.0403 \\
BGE pooled + Node2Vec (uncorrected) & 0.76\% & 7.83\% & 32.64\% & 50.74\% & 0.0376 & 0.1176 & 0.5074 & 0.0358 \\
BGE-M3 + Node2Vec (uncorrected) & 0.76\% & 7.83\% & 32.64\% & 50.74\% & 0.0376 & 0.1176 & 0.5074 & 0.0358 \\
Node2Vec (uncorrected) & 0.75\% & 7.81\% & 32.52\% & 50.60\% & 0.0375 & 0.1172 & 0.5060 & 0.0357 \\
Node2Vec (corrected) & 0.75\% & 7.81\% & 32.52\% & 50.60\% & 0.0375 & 0.1172 & 0.5060 & 0.0356 \\
GCN + BGE-M3 (rank fusion) & 0.85\% & 7.63\% & 23.14\% & 33.77\% & 0.0335 & 0.0862 & 0.3377 & 0.0317 \\
BGE-M3 Only & 1.35\% & 7.57\% & 19.69\% & 27.73\% & 0.0366 & 0.0788 & 0.2773 & 0.0351 \\
GCN Only & 0.38\% & 3.46\% & 14.12\% & 22.91\% & 0.0180 & 0.0530 & 0.2291 & 0.0163 \\
GraphSAGE Only & 0.17\% & 1.22\% & 4.96\% & 8.72\% & 0.0076 & 0.0199 & 0.0872 & 0.0061 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Recommendation-quality metrics on top-20 recommendation lists over 9,022 evaluation nodes.}
\begin{tabular}{>{\raggedright\arraybackslash}p{0.30\textwidth}
                ...
                >{\raggedleft\arraybackslash}p{0.12\textwidth}}
\toprule
\textbf{Model} & \textbf{Pop. Lift} & \textbf{Gini} & \textbf{Agg. Div.} & \textbf{Novelty} & \textbf{ILD} \\
\midrule
GCN Only & 1.1879 & 0.2607 & 11,685 & 14.3293 & 0.5135 \\
GCN + BGE-M3 (rank fusion) & 1.6650 & 0.4228 & 11,655 & 13.9222 & 0.4366 \\
GraphSAGE Only & 1.3134 & 0.2517 & 11,628 & 14.2087 & 0.5313 \\
BGE pooled + Node2Vec (corrected) & 1.3301 & 0.4110 & 11,326 & 14.2738 & 0.4372 \\
BGE-M3 + Node2Vec (corrected) & 1.3081 & 0.4127 & 11,268 & 14.2783 & 0.4316 \\
BGE pooled + Node2Vec (uncorrected) & 1.3397 & 0.4613 & 11,186 & 14.0351 & 0.4558 \\
BGE-M3 + Node2Vec (uncorrected) & 1.3400 & 0.4605 & 11,164 & 14.0340 & 0.4557 \\
Node2Vec (uncorrected) & 1.3374 & 0.4482 & 10,966 & 14.0466 & 0.4569 \\
Node2Vec (corrected) & 1.3374 & 0.4482 & 10,966 & 14.0466 & 0.4569 \\
BGE-M3 Only & 1.9413 & 0.5172 & 10,905 & 13.8459 & 0.3713 \\
\bottomrule
\end{tabular}
\end{table}
