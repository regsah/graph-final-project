...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img-1-alibaba/degree_distribution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{img-1-alibaba/degree_distribution_loglog.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img-1-alibaba/topic_link_cosine.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img-1-alibaba/topic_link_pearson.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img-1-alibaba/topic_link_euclidean.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img-1-alibaba/local_transitivity.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img-1-alibaba/similarityxdegree.png}
...
\begin{itemize}
    \item For low-degree nodes the similarity values span a wide range,
          while for high-degree hubs the spread narrows and converges toward
          the population mean.  This variance reduction is expected: hubs
          connect to many diverse articles, so their average similarity
          regresses toward the global mean.
    \item A cluster of edges with cosine similarity close to~$1.0$ (and
          Euclidean distance close to~$0$) is visible at low degrees,
          corresponding to pairs of near-duplicate or closely related articles
          that share few other links.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img-1-alibaba/cosinexlocaltransitivity.png}
    \caption{Cosine similarity vs.\ local transitivity of the source node
             (left) and the target node (right).}
    \label{fig:cos_cc}
\end{figure}

The scatter plots show a slight positive trend: edges incident to nodes with
higher clustering coefficients tend to exhibit somewhat higher cosine
similarity.  This suggests that tightly-knit local neighbourhoods---where
many neighbours are also interconnected---tend to be more topically coherent.
Nevertheless, the relationship is weak and spread is substantial across all
CC values, indicating that local transitivity alone is not a strong predictor
